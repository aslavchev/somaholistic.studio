              ...
              <div className="space-y-5 text-lg text-muted-foreground">
                <p className="leading-relaxed">
                  {t(
                    ...
                    "Mi chiamo Mariana Igova e lavoro nel campo della trasformazione personale e del benessere olistico da oltre sette anni. Credo che la vera guarigione avvenga attraverso una visione olistica della persona – quando corpo, emozioni, mente e spirito sono visti come un sistema connesso e vivente. Questa filosofia è alla base dello studio che ho creato – un luogo dedicato all'equilibrio, al ritorno a se stessi e alla chiarezza interiore."
                  )}
                </p>
                  ...
                  <>
                    <p className="leading-relaxed">
                      {t(
                        ...
                        "Le pratiche somatiche fanno parte della mia vita da più di 25 anni. Sin dall'inizio ho capito che il corpo porta la sua saggezza – un linguaggio silenzioso che parla attraverso sensazioni, impulsi e segnali sottili. Nel tempo ho imparato ad ascoltarlo e ad aiutare gli altri a sentire il suo messaggio. Per me, il corpo è la porta verso la nostra verità profonda, e il movimento e il respiro sono gli strumenti naturali per la liberazione, il rinnovamento e il ripristino dell'armonia."
                      )}
                    </p>
                    <p className="leading-relaxed">
                      {t(
                        ...
                        "Il mio lavoro include varie terapie mirate a muovere il flusso nel corpo, supportare l'energia vitale e creare spazio interiore per l'integrazione. Utilizzo pratiche manuali, olistiche ed energetiche che supportano il rilascio della tensione e il ritorno della sensazione di leggerezza. Da anni mi occupo anche di lavoro energetico – una direzione che ha arricchito il mio approccio terapeutico e mi ha permesso di lavorare in modo ancora più sottile, attraverso livelli che spesso rimangono invisibili, ma influenzano fortemente la nostra condizione."
                      )}
                    </p>
                    <p className="leading-relaxed">
                      {t(
                        ...
                        "Nelle mie sessioni integro respiro, presenza consapevole e movimento delicato quando necessario – come percorso verso una connessione più profonda con se stessi e rilascio naturale di emozioni e blocchi."
                      )}
                    </p>
                    <p className="leading-relaxed">
                      {t(
                        ...
                        "Lo studio che ho creato è uno spazio per autenticità, leggerezza e trasformazione. Un luogo dove si può incontrare se stessi veramente, con calma e fiducia. Sono felice di essere un supporto in questo processo di ritorno alla completezza e alla casa interiore."
                      )}
                    </p>
                  </>
                )}
                ...
                {isMobile && (
                  <button
                    ...
                    aria-label={isExpanded ? t("Покажи по-малко", "Show less", "Mostra meno") : t("Прочети повече", "Read more", "Leggi di più")}
                  >
                    {isExpanded ? t("Покажи по-малко", "Show less", "Mostra meno") : t("Прочети повече", "Read more", "Leggi di più")}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-lg bg-accent/50" data-testid="about-skills-certified">
                ...
                <h3 className="font-semibold text-foreground mb-2">
                  {t("Сертифицирани умения", "Certified Skills", "Competenze Certificate")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t(
                    ...
                    "Formazione in massaggio thailandese tradizionale, tecniche classiche e terapia olistica"
                  )}
                </p>
              </div>
              ...
              <div className="text-center p-6 rounded-lg bg-accent/50" data-testid="about-skills-individual">
                ...
                <h3 className="font-semibold text-foreground mb-2">
                  {t("Индивидуален подход", "Individual Approach", "Approccio Individuale")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t(
                    "Всяка терапия е персонализирана според вашите нужди и цели",
                    "Each therapy is personalized according to your needs and goals",
                    "Ogni terapia è personalizzata secondo le tue esigenze e obiettivi"
                  )}
                </p>
              </div>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground text-center lg:text-left">
              <p className="leading-relaxed mb-4">
                {t(
                  ...
                  "In SOMA STUDIO, crediamo che il vero benessere provenga dall'equilibrio tra salute fisica ed emotiva. Ogni terapia è creata con attenzione ai dettagli e profonda comprensione dei processi somatici."
                )}
              </p>
              <p className="leading-relaxed">
                {t(
                  ...
                  "La nostra missione è creare uno spazio dove puoi rilassarti completamente, connetterti con te stesso e ripristinare la tua armonia interiore."
                )}
              </p>
            </div>
          </div>
